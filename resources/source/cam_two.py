...
def capture_picture(test_name):
    ...
    directory = os.getcwd()
    capture_dir = os.path.join(directory, "capture_result")
    os.makedirs(capture_dir, exist_ok=True)
    screenshot_name = os.path.join(capture_dir, f"{test_name}.png")
    # 뷰포트 너머까지 캡쳐하기
...
def vertical():
    ...
    # 270도
    element = driver.find_element(By.CSS_SELECTOR, '#real_corridor_mode > option:nth-child(2)')
    element.click()
    driver.find_element(By.XPATH, '//*[@id="btnSaveSetup"]').send_keys(Keys.ENTER)
    time.sleep(10)
